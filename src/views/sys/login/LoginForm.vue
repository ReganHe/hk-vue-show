<template>
  ...
  >
    ...
    <FormItem name="captcha" style="margin-bottom: 12px">
      <div class="form-item-captcha">
        <Input
          ...
          class="input-captcha"
        />
        <div class="captcha-img-wrapper" @click="handleRefreshCaptcha">
          <Image
            class="captcha-img"
            :src="formData.captchaImageUrl"
            fit="cover"
            :preview="false"
            height="40px"
          />
          <div class="captcha-tip" @click="handleRefreshCaptcha">看不清？换一张</div>
        </div>
      </div>
    </FormItem>
...
<script lang="ts" setup>
  ...
  import { captcha } from '/@/api/auto/ApiGwsAccount';
  ...
  const handleRefreshCaptcha = async () => {
    ...
    formData.captchaImageUrl = res.image;
    formData.bindKey = res.bindKey;
    formData.captcha = '';
  };
